...
function FiltrarIndicativo(){
  ...
  $.post('https://app.emsivoz.co/funciones/prod/programadas/indicativos.php',{'pais':pais},function(data){
    console.log(data);
     var print=JSON.parse(data);
     var tabla='<table  class=" bordered centered" id="tab"><thead><tr><th style="font-size:20px">Destino</th><th style="font-size:20px">Celular</th><th style="font-size:20px">Fijo</th> </tr></thead>';
     for (var i = 0; i < print.length;i++){
          ...
          var td='<tbody><tr><td style="font-size:20px">'+print[i]['nombre']+'</td><td style="font-size:20px">'+print[i]['celular']+'</td><td style="font-size:20px">'+print[i]['fijo']+'</td></tr></tbody>';
     }
...
function FiltrarTarifa(){
  ...
  $.post('https://app.emsivoz.co/funciones/prod/programadas/tarifas.php',{'pais':pais},function(data){
    console.log(data);
     var print=JSON.parse(data);
     var td="";
     var tabla='<table class=" bordered centered" id="tab"><thead><tr><th style="font-size:20px">Destino</th><th style="font-size:20px">Celular</th><th style="font-size:20px">Fijo</th> </tr></thead><tbody><tr><td style="font-size:20px">'+print[0]['nombre']+'</td>';
     for (var i = 0; i < print.length;i++){
         ...
         td=td+'<td style="font-size:20px">$ '+print[i]['precio']+'</td>';
     }
                  ...
                  nombre=print[0]['nombre'];
                    if(print[0]['indi'] == 1){
                      if(print[0]['precio'] == print[2]['precio']){
                        precio='<span style="color:#ADACB2"> $'+print[0]['precio']+' Min </span>';
                      }else{
                         precio='<span style="color:#ADACB2;font-size:14px"><del> $'+print[2]['precio']+'</del> |</span><span style="color:#89B137;font-size:14px">Hoy</span><span style="color:#89B137"> $'+print[0]['precio']+' Min </span>';
                      }
                    }else{
                      if(print[1]['precio'] == print[3]['precio']){
                        precio='<span style="color:#ADACB2"> $'+print[1]['precio']+' Min </span>';
                      }else{
                         precio='<span style="color:#ADACB2;font-size:14px"><del> $'+print[3]['precio']+'</del> |</span><span style="color:#89B137;font-size:14px">Hoy</span><span style="color:#89B137"> $'+print[1]['precio']+' Min </span>';
                      }
                    }
...
function ValorLlamada(numero){
  ...
  setTimeout(function(){
      ...
      if(imd == true){
          ...
          text = text + '<span class="conPais">'+nombre+'</span>'+precio;
      }else{
        Colombia();
        text = $('#connect').html();
      }        
